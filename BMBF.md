...
## Analysing the Code
BMBF Uses DLL files coded in XAMARIAN we  an XAMARIAN unpacking tool then we are able to unpack them, then we use DNSPY to analyze them. The following is information found within those DLL files.
